...
<form  method="post" action="${contextPath}/member/editMember.do?mid=${memInfo.mid}">
 <table align="center" >
   <tr>
     <td width="200"><p align="right" >아이디</td>
     <td width="400"><input   type="text" name="mid" value="${memInfo.mid}" disabled ></td>
 ...
 <tr>
   ...
   <tr>
     ...
     <td width="400"><input   type="text" name="mname" value="${memInfo.mname}" ></td>
   </tr>
   <tr>
